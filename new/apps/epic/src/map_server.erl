...
-spec find_working_step(dicts:dict(), integer(), integer(), integer()) ->
                               error | coords().
...
-spec do_steps(dicts:dict(), integer(), integer(), [integer(),...]) ->
                      coords() | error;
              (dicts:dict(),integer(), integer(),[]) ->
                      error.
...
-spec try_direction(dicts:dict(), integer(), integer(), integer()) ->
                           error | coords().
